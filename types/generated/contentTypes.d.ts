...
export interface ApiAutherAuther extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::auther.auther'>;
  };
}
...
export interface ApiMessageMessage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    enqType: Schema.Attribute.Enumeration<['AR', 'EN', 'FR', 'GR']> &
      Schema.Attribute.Required;
...
export interface ApiRecipeRecipe extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    title: Schema.Attribute.String &
      ...
      Schema.Attribute.Unique;
    cover: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    prepTime: Schema.Attribute.BigInteger & Schema.Attribute.Required;
    cookTime: Schema.Attribute.BigInteger & Schema.Attribute.Required;
    brief: Schema.Attribute.Text & Schema.Attribute.Required;
    auther: Schema.Attribute.Relation<'manyToOne', 'api::auther.auther'>;
    category: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
    ingredients: Schema.Attribute.Component<'todo-list.ingredients', true>;
    nutritionInfo: Schema.Attribute.Component<
      'info-list.nutrition-info',
      false
    >;
    directions: Schema.Attribute.Component<'todo-list.ingredients', false>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
